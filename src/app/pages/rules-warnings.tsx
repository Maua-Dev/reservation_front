...
export default function RulesWarnings() {
  return (
    <div className="bg-red-30 flex h-[100vh] w-full flex-col items-center justify-start pt-20">
      ...
      <div className="flex h-[80px] w-[900px] items-center justify-center bg-blue-400 text-center text-4xl text-white rounded-md">
      ...
      <div className="flex h-[10px] w-full items-start justify-between px-[40rem] pl-20 pt-12 text-2xl text-blue-700">
        <div>
          <div className='w-[500px] pb-5 font-poppins font-bold text-center text-blue-500'>Avisos</div>
            <div className='h-[600px] w-[600px] overflow-auto'>
              <CardWarnings titulo="Quadra 1" data="24/10 à 26/10" conteudo="A quadra estará fechada por causa do evento Eureka bla bla bla bla bla bla bla lba lba bla bla lbabla lbablal bablabl "></CardWarnings>
              <CardWarnings titulo="Todas" data="24/10 à 26/10" conteudo="A quadra estará fechada por causa do evento Eureka"></CardWarnings>
              <CardWarnings titulo="Todas" data="24/10 à 26/10" conteudo="A quadra estará fechada por causa do evento Eureka"></CardWarnings>
              <CardWarnings titulo="Todas" data="24/10 à 26/10" conteudo="A quadra estará fechada por causa do evento Eureka"></CardWarnings>
              <CardWarnings titulo="Todas" data="24/10 à 26/10" conteudo="A quadra estará fechada por causa do evento Eureka"></CardWarnings>
              <CardWarnings titulo="Todas" data="24/10 à 26/10" conteudo="A quadra estará fechada por causa do evento Eureka"></CardWarnings>
