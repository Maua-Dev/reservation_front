    ...
    <main className="flex h-screen flex-col items-center justify-center">
      <section className="flex w-full flex-col items-center bg-blue-primary py-20">
        ...
        <div className="flex flex-col items-center gap-4 px-8 md:flex-row">
          <div className="text-md flex flex-col font-poppins text-white lg:text-xl">
            <p className="">
          ...
          <img
            ...
            alt=""
            className="h-auto w-full max-w-sm rounded-md border-2 border-white md:max-w-sm lg:max-w-xl"
          />
        </div>
      </section>
    </main>
