...
export function Reservations() {
  ...
  return (
    <section id="reservation" className="scroll-smooth">
      <div className="flex h-auto min-h-screen max-w-7xl flex-col items-center justify-center gap-10 py-10 md:gap-24 md:px-12">
        ...
        <div className="flex w-full flex-col items-center justify-center gap-6 px-3 md:flex-row">
