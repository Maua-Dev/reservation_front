  ...
  return (
    <div className={`fixed inset-0 z-20 flex items-center justify-center`}>
      ...
      >
        ...
        <header className='flex h-12 pb-6 w-full items-center justify-start gap-6 border-b-2 border-black px-4'>
          <h2 className='text-3xl font-semibold'>CEAF</h2>
          <p className='bold text-xl'>Manutenção</p>
        </header>
        <div className='flex h-[90%] items-start justify-start pt-8'>
          ...
          <div className='flex w-2/3 flex-col items-center justify-start gap-4 px-4 py-2'>
            {/* horario */}
